...
namespace HallownestVocalizedAudioLoader.UI;
public static class ExtrasMenu
{
    ...
    public static void AddCreditsButton()
    {
        ...
        mb.submitAction = _ => HallownestVocalizedAudioLoaderMod.CoroutineHolder.StartCoroutine(MajorFeatures.RollCredits.LoadCreditsFromMenu());
