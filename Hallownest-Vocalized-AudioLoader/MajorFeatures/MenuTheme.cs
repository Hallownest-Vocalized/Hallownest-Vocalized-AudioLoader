...
public class MenuTheme : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _video.clip = HallownestVocalizedAudioLoaderMod.styleBundle.LoadAsset<VideoClip>("Sequence_03");
        _video.SetTargetAudioSource(0, aSourceVid);
        DontDestroyOnLoad(_video.clip);

        _audio = gameObject.GetComponents<AudioSource>()[1];
        _audio.clip = HallownestVocalizedAudioLoaderMod.styleBundle.LoadAsset<AudioClip>("HV_Title_Card_music_compressed");
